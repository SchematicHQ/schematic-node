    ...
    test("getCheckoutData (1)", async () => {
        ...
        const rawResponseBody = {
            data: {
                ...
                company_can_trial_selected_plan: true,
                ...
                selected_plan_already_trialed: true,
        ...
        expect(response).toEqual({
            data: {
                ...
                companyCanTrialSelectedPlan: true,
                ...
                selectedPlanAlreadyTrialed: true,
        ...
        const rawResponseBody = {
            data: {
                ...
                finance: {
                    ...
                    proration: 1000000,
                    proration_billed_at: "2024-01-15T09:30:00Z",
                    tax_amount: 1000000,
        ...
        expect(response).toEqual({
            data: {
                ...
                finance: {
                    ...
                    proration: 1000000,
                    prorationBilledAt: new Date("2024-01-15T09:30:00.000Z"),
                    taxAmount: 1000000,
    ...
    test("getCompanyBillingDetails (1)", async () => {
        ...
        const rawResponseBody = {
            data: {
                ...
                email: "email",
                phone: "phone",
                tax_ids: [{ country: "country", id: "id", type: "type", value: "value" }],
            },
            params: { key: "value" },
        };
