...
export const CountCompanyOverridesParams: core.serialization.ObjectSchema<
  serializers.CountCompanyOverridesParams.Raw,
  Schematic.CountCompanyOverridesParams
