...
export const GetFeatureUsageTimeSeriesParams: core.serialization.ObjectSchema<
    serializers.GetFeatureUsageTimeSeriesParams.Raw,
    Schematic.GetFeatureUsageTimeSeriesParams
...
export declare namespace GetFeatureUsageTimeSeriesParams {
