...
export const CountCreditSpendPoliciesParams: core.serialization.ObjectSchema<
    serializers.CountCreditSpendPoliciesParams.Raw,
    Schematic.CountCreditSpendPoliciesParams
