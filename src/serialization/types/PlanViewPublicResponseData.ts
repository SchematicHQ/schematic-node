...
export const PlanViewPublicResponseData: core.serialization.ObjectSchema<
    serializers.PlanViewPublicResponseData.Raw,
    Schematic.PlanViewPublicResponseData
...
export declare namespace PlanViewPublicResponseData {
