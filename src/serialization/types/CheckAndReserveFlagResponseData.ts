...
import { FlagCheckReservationResponseData } from "./FlagCheckReservationResponseData";
import { MetricPeriod } from "./MetricPeriod";
import { RuleType } from "./RuleType";

export const CheckAndReserveFlagResponseData: core.serialization.ObjectSchema<
    serializers.CheckAndReserveFlagResponseData.Raw,
    Schematic.CheckAndReserveFlagResponseData
> = core.serialization.object({
    ...
    reservation: FlagCheckReservationResponseData.optional(),
...
export declare namespace CheckAndReserveFlagResponseData {
    export interface Raw {
        ...
        flag_id?: string | null;
        reason: string;
        reservation?: FlagCheckReservationResponseData.Raw | null;
        rule_id?: string | null;
