...
export const CreditUsageResponseData: core.serialization.ObjectSchema<
    serializers.CreditUsageResponseData.Raw,
    Schematic.CreditUsageResponseData
> = core.serialization.object({
    ...
    creditGrantDetails: core.serialization.property("credit_grant_details", core.serialization.list(CreditGrantDetail)),
...
export declare namespace CreditUsageResponseData {
    export interface Raw {
        credit_consumption_rate?: number | null;
        credit_grant_counts?: Record<string, number> | null;
        credit_grant_details: CreditGrantDetail.Raw[];
