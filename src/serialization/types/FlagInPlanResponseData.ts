...
export const FlagInPlanResponseData: core.serialization.ObjectSchema<
    serializers.FlagInPlanResponseData.Raw,
    Schematic.FlagInPlanResponseData
...
export declare namespace FlagInPlanResponseData {
