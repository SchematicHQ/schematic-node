...
export const FeatureEntitlementMonthReset = {
    FirstOfMonth: "first_of_month",
    BillingCycle: "billing_cycle",
} as const;
export type FeatureEntitlementMonthReset =
    (typeof FeatureEntitlementMonthReset)[keyof typeof FeatureEntitlementMonthReset];
