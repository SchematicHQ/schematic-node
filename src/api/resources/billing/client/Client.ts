...
export class BillingClient {
    ...
    private async __upsertBillingCoupon(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.CreateCouponRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
     ...
     */
    public deleteBillingCoupon(
        billing_id: string,
        requestOptions?: BillingClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.DeleteBillingCouponResponse> {
        return core.HttpResponsePromise.fromPromise(this.__deleteBillingCoupon(billing_id, requestOptions));
    }

    private async __deleteBillingCoupon(
        billing_id: string,
        requestOptions?: BillingClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.DeleteBillingCouponResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SchematicEnvironment.Default,
                `billing/coupons/${core.url.encodePathParam(billing_id)}`,
            ),
            method: "DELETE",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
        ...
        if (_response.ok) {
            return {
                data: serializers.DeleteBillingCouponResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
     ...
     */
    public deleteBillingCustomer(
        billing_id: string,
        requestOptions?: BillingClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.DeleteBillingCustomerResponse> {
        return core.HttpResponsePromise.fromPromise(this.__deleteBillingCustomer(billing_id, requestOptions));
    }

    private async __deleteBillingCustomer(
        billing_id: string,
        requestOptions?: BillingClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.DeleteBillingCustomerResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SchematicEnvironment.Default,
                `billing/customer/${core.url.encodePathParam(billing_id)}`,
            ),
            method: "DELETE",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
        ...
        if (_response.ok) {
            return {
                data: serializers.DeleteBillingCustomerResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __upsertBillingCustomer(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.CreateBillingCustomerRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
    ...
    private async __upsertInvoice(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.CreateInvoiceRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
     ...
     */
    public deleteBillingInvoice(
        billing_id: string,
        requestOptions?: BillingClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.DeleteBillingInvoiceResponse> {
        return core.HttpResponsePromise.fromPromise(this.__deleteBillingInvoice(billing_id, requestOptions));
    }

    private async __deleteBillingInvoice(
        billing_id: string,
        requestOptions?: BillingClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.DeleteBillingInvoiceResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SchematicEnvironment.Default,
                `billing/invoices/${core.url.encodePathParam(billing_id)}`,
            ),
            method: "DELETE",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
        ...
        if (_response.ok) {
            return {
                data: serializers.DeleteBillingInvoiceResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __upsertBillingMeter(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.CreateMeterRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
    ...
    private async __upsertPaymentMethod(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.CreatePaymentMethodRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
    ...
    private async __upsertBillingPrice(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.CreateBillingPriceRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
    ...
    private async __upsertBillingProduct(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.CreateBillingProductRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
    ...
    /**
     * @param {Schematic.ListCompanyBillingProfilesRequest} request
     * @param {BillingClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
     ...
     *     })
     */
    public listCompanyBillingProfiles(
        request: Schematic.ListCompanyBillingProfilesRequest = {},
        requestOptions?: BillingClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.ListCompanyBillingProfilesResponse> {
        return core.HttpResponsePromise.fromPromise(this.__listCompanyBillingProfiles(request, requestOptions));
    }

    private async __listCompanyBillingProfiles(
        request: Schematic.ListCompanyBillingProfilesRequest = {},
        requestOptions?: BillingClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.ListCompanyBillingProfilesResponse>> {
        const { companyId, isDefault, providerType, limit, offset } = request;
        const _queryParams: Record<string, unknown> = {
            company_id: companyId,
        ...
        if (_response.ok) {
            return {
                data: serializers.ListCompanyBillingProfilesResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/billing/profiles");
    }

    /**
     * @param {string} billing_profile_id - billing_profile_id
     * @param {Schematic.UpdateCompanyBillingProfileRequestBody} request
     * @param {BillingClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
     ...
     *     })
     */
    public updateCompanyBillingProfile(
        billing_profile_id: string,
        request: Schematic.UpdateCompanyBillingProfileRequestBody,
        requestOptions?: BillingClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.UpdateCompanyBillingProfileResponse> {
        return core.HttpResponsePromise.fromPromise(
            this.__updateCompanyBillingProfile(billing_profile_id, request, requestOptions),
        );
    }

    private async __updateCompanyBillingProfile(
        billing_profile_id: string,
        request: Schematic.UpdateCompanyBillingProfileRequestBody,
        requestOptions?: BillingClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.UpdateCompanyBillingProfileResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SchematicEnvironment.Default,
                `billing/profiles/${core.url.encodePathParam(billing_profile_id)}`,
            ),
            method: "PUT",
            headers: _headers,
            contentType: "application/json",
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.UpdateCompanyBillingProfileRequestBody.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.UpdateCompanyBillingProfileResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "PUT",
            "/billing/profiles/{billing_profile_id}",
        );
    }
    ...
    private async __upsertBillingSubscription(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.CreateBillingSubscriptionRequestBody.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                }),
                requestOptions?.additionalBodyParameters,
            ),
