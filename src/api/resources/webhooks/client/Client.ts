...
export class WebhooksClient {
    ...
    /**
     * @param {string} webhook_id - webhook_id
     * @param {Schematic.TestWebhookRequestBody} request
     * @param {WebhooksClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
     ...
     *     })
     */
    public sendTestWebhookAction(
        webhook_id: string,
        request: Schematic.TestWebhookRequestBody,
        requestOptions?: WebhooksClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.SendTestWebhookActionResponse> {
        return core.HttpResponsePromise.fromPromise(this.__sendTestWebhookAction(webhook_id, request, requestOptions));
    }

    private async __sendTestWebhookAction(
        webhook_id: string,
        request: Schematic.TestWebhookRequestBody,
        requestOptions?: WebhooksClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.SendTestWebhookActionResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SchematicEnvironment.Default,
                `webhooks/${core.url.encodePathParam(webhook_id)}/test`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        if (_response.ok) {
            return {
                data: serializers.SendTestWebhookActionResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/webhooks/{webhook_id}/test");
    }
