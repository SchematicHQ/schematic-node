...
export interface ListCompaniesForAdvancedFilterRequest {
    ...
    subscription_statuses?: Schematic.SubscriptionStatus | Schematic.SubscriptionStatus[];
    /** Filter companies by one or more subscription types (paid, free, trial) */
    subscription_types?: Schematic.SubscriptionType | Schematic.SubscriptionType[];
