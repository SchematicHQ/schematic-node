...
export class CompaniesClient {
    ...
    /**
     * @param {Schematic.GetCompanyBillingEntityRequest} request
     * @param {CompaniesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
    ...
    /**
     * @param {string} entity_key_definition_id - entity_key_definition_id
     * @param {CompaniesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
     ...
     */
    public deleteEntityKeyDefinition(
        entity_key_definition_id: string,
        requestOptions?: CompaniesClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.DeleteEntityKeyDefinitionResponse> {
        return core.HttpResponsePromise.fromPromise(
            this.__deleteEntityKeyDefinition(entity_key_definition_id, requestOptions),
        );
    }

    private async __deleteEntityKeyDefinition(
        entity_key_definition_id: string,
        requestOptions?: CompaniesClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.DeleteEntityKeyDefinitionResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SchematicEnvironment.Default,
                `entity-key-definitions/${core.url.encodePathParam(entity_key_definition_id)}`,
            ),
            method: "DELETE",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
        ...
        if (_response.ok) {
            return {
                data: serializers.DeleteEntityKeyDefinitionResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "DELETE",
            "/entity-key-definitions/{entity_key_definition_id}",
        );
    }
    ...
    /**
     * @param {Schematic.CountEntityKeysRequest} request
     * @param {CompaniesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
     ...
     *     })
     */
    public countEntityKeys(
        request: Schematic.CountEntityKeysRequest = {},
        requestOptions?: CompaniesClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.CountEntityKeysResponse> {
        return core.HttpResponsePromise.fromPromise(this.__countEntityKeys(request, requestOptions));
    }

    private async __countEntityKeys(
        request: Schematic.CountEntityKeysRequest = {},
        requestOptions?: CompaniesClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.CountEntityKeysResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.CountEntityKeysResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/entity-keys/count");
    }
