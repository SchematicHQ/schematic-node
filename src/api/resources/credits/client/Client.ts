...
export class CreditsClient {
    ...
    private async __createBillingCredit(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.CreateBillingCreditRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
    ...
    private async __updateBillingCredit(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.UpdateBillingCreditRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
    ...
    /**
     * @param {Schematic.ListCompanyCreditBalancesRequest} request
     * @param {CreditsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
     ...
     *     })
     */
    public listCompanyCreditBalances(
        request: Schematic.ListCompanyCreditBalancesRequest,
        requestOptions?: CreditsClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.ListCompanyCreditBalancesResponse> {
    ...
    private async __listCompanyCreditBalances(
        request: Schematic.ListCompanyCreditBalancesRequest,
        requestOptions?: CreditsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.ListCompanyCreditBalancesResponse>> {
    ...
    private async __createCreditBundle(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.CreateCreditBundleRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
    ...
    private async __updateCreditBundleDetails(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.UpdateCreditBundleDetailsRequestBody.jsonOrThrow(request, {
    ...
    private async __zeroOutGrant(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.ZeroOutGrantRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
    ...
    private async __grantBillingCreditsToCompany(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.CreateCompanyCreditGrant.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
     ...
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
     * @throws {@link Schematic.PaymentRequiredError}
     * @throws {@link Schematic.ForbiddenError}
     * @throws {@link Schematic.NotFoundError}
     * @throws {@link Schematic.InternalServerError}
     * @throws {@link errors.SchematicError}
    ...
    private async __acquireCreditLease(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.AcquireCreditLeaseRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                ...
                case 402:
                    throw new Schematic.PaymentRequiredError(
                        serializers.ApiError.parseOrThrow(_response.error.body, {
                            unrecognizedObjectKeys: "passthrough",
                            allowUnrecognizedUnionMembers: true,
                            allowUnrecognizedEnumValues: true,
    ...
    private async __extendCreditLease(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.ExtendCreditLeaseRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
    ...
    private async __releaseCreditLease(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.ReleaseCreditLeaseRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
    ...
    private async __createBillingPlanCreditGrant(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.CreateBillingPlanCreditGrantRequestBody.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                }),
                requestOptions?.additionalBodyParameters,
            ),
     ...
     */
    public getSingleBillingPlanCreditGrant(
        plan_grant_id: string,
        requestOptions?: CreditsClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.GetSingleBillingPlanCreditGrantResponse> {
        return core.HttpResponsePromise.fromPromise(
            this.__getSingleBillingPlanCreditGrant(plan_grant_id, requestOptions),
        );
    }

    private async __getSingleBillingPlanCreditGrant(
        plan_grant_id: string,
        requestOptions?: CreditsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.GetSingleBillingPlanCreditGrantResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: serializers.GetSingleBillingPlanCreditGrantResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __updateBillingPlanCreditGrant(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.UpdateBillingPlanCreditGrantRequestBody.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                }),
                requestOptions?.additionalBodyParameters,
            ),
    ...
    /**
     * @param {Schematic.ReserveCreditsRequestBody} request
     * @param {CreditsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
    ...
    public reserveCredits(
        ...
        requestOptions?: CreditsClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.ReserveCreditsResponse> {
        return core.HttpResponsePromise.fromPromise(this.__reserveCredits(request, requestOptions));
    }

    private async __reserveCredits(
        request: Schematic.ReserveCreditsRequestBody,
        requestOptions?: CreditsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.ReserveCreditsResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.ReserveCreditsRequestBody.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
                requestOptions?.additionalBodyParameters,
            ),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
        ...
        if (_response.ok) {
            return {
                data: serializers.ReserveCreditsResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
     ...
     * @param {Schematic.ReleaseCreditReservationRequestBody} request
     * @param {CreditsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
     ...
     *     })
     */
    public releaseCreditReservation(
        reservation_id: string,
        request: Schematic.ReleaseCreditReservationRequestBody,
        requestOptions?: CreditsClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.ReleaseCreditReservationResponse> {
        return core.HttpResponsePromise.fromPromise(
            this.__releaseCreditReservation(reservation_id, request, requestOptions),
        );
    }

    private async __releaseCreditReservation(
        reservation_id: string,
        request: Schematic.ReleaseCreditReservationRequestBody,
        requestOptions?: CreditsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.ReleaseCreditReservationResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SchematicEnvironment.Default,
                `billing/credits/reservations/${core.url.encodePathParam(reservation_id)}/release`,
            ),
            method: "PUT",
            headers: _headers,
            contentType: "application/json",
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.ReleaseCreditReservationRequestBody.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                }),
                requestOptions?.additionalBodyParameters,
            ),
        ...
        if (_response.ok) {
            return {
                data: serializers.ReleaseCreditReservationResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "PUT",
            "/billing/credits/reservations/{reservation_id}/release",
        );
    }

    /**
     * @param {Schematic.ListCreditSpendPoliciesRequest} request
     * @param {CreditsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
     ...
     *     })
     */
    public listCreditSpendPolicies(
        request: Schematic.ListCreditSpendPoliciesRequest = {},
        requestOptions?: CreditsClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.ListCreditSpendPoliciesResponse> {
        return core.HttpResponsePromise.fromPromise(this.__listCreditSpendPolicies(request, requestOptions));
    }

    private async __listCreditSpendPolicies(
        request: Schematic.ListCreditSpendPoliciesRequest = {},
        requestOptions?: CreditsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.ListCreditSpendPoliciesResponse>> {
        const { billingCreditId, companyId, scopeType, userId, userIds, limit, offset } = request;
        const _queryParams: Record<string, unknown> = {
            billing_credit_id: billingCreditId,
            company_id: companyId,
            scope_type:
                scopeType != null
                    ? serializers.CreditSpendPolicyScope.jsonOrThrow(scopeType, { unrecognizedObjectKeys: "strip" })
                    : undefined,
            user_id: userId,
            user_ids: userIds,
            limit,
        ...
        if (_response.ok) {
            return {
                data: serializers.ListCreditSpendPoliciesResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    /**
     * @param {Schematic.CreateCreditSpendPolicyRequestBody} request
     * @param {CreditsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
     ...
     *     })
     */
    public createCreditSpendPolicy(
        request: Schematic.CreateCreditSpendPolicyRequestBody,
        requestOptions?: CreditsClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.CreateCreditSpendPolicyResponse> {
        return core.HttpResponsePromise.fromPromise(this.__createCreditSpendPolicy(request, requestOptions));
    }

    private async __createCreditSpendPolicy(
        request: Schematic.CreateCreditSpendPolicyRequestBody,
        requestOptions?: CreditsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.CreateCreditSpendPolicyResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.CreateCreditSpendPolicyRequestBody.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                }),
                requestOptions?.additionalBodyParameters,
            ),
        ...
        if (_response.ok) {
            return {
                data: serializers.CreateCreditSpendPolicyResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    /**
     * @param {string} spend_policy_id - spend_policy_id
     * @param {CreditsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.UnauthorizedError}
     * @throws {@link Schematic.ForbiddenError}
     ...
     */
    public getCreditSpendPolicy(
        spend_policy_id: string,
        requestOptions?: CreditsClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.GetCreditSpendPolicyResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getCreditSpendPolicy(spend_policy_id, requestOptions));
    }

    private async __getCreditSpendPolicy(
        spend_policy_id: string,
        requestOptions?: CreditsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.GetCreditSpendPolicyResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SchematicEnvironment.Default,
                `billing/credits/spend-policies/${core.url.encodePathParam(spend_policy_id)}`,
            ),
            method: "GET",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
        ...
        if (_response.ok) {
            return {
                data: serializers.GetCreditSpendPolicyResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    /**
     * @param {string} spend_policy_id - spend_policy_id
     * @param {Schematic.UpdateCreditSpendPolicyRequestBody} request
     * @param {CreditsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
     ...
     */
    public updateCreditSpendPolicy(
        spend_policy_id: string,
        request: Schematic.UpdateCreditSpendPolicyRequestBody = {},
        requestOptions?: CreditsClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.UpdateCreditSpendPolicyResponse> {
        return core.HttpResponsePromise.fromPromise(
            this.__updateCreditSpendPolicy(spend_policy_id, request, requestOptions),
        );
    }

    private async __updateCreditSpendPolicy(
        spend_policy_id: string,
        request: Schematic.UpdateCreditSpendPolicyRequestBody = {},
        requestOptions?: CreditsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.UpdateCreditSpendPolicyResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.UpdateCreditSpendPolicyRequestBody.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "strip",
                }),
                requestOptions?.additionalBodyParameters,
            ),
        ...
        if (_response.ok) {
            return {
                data: serializers.UpdateCreditSpendPolicyResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
     ...
     */
    public deleteCreditSpendPolicy(
        spend_policy_id: string,
        requestOptions?: CreditsClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.DeleteCreditSpendPolicyResponse> {
        return core.HttpResponsePromise.fromPromise(this.__deleteCreditSpendPolicy(spend_policy_id, requestOptions));
    }

    private async __deleteCreditSpendPolicy(
        spend_policy_id: string,
        requestOptions?: CreditsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.DeleteCreditSpendPolicyResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: serializers.DeleteCreditSpendPolicyResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
     ...
     *     })
     */
    public countCreditSpendPolicies(
        request: Schematic.CountCreditSpendPoliciesRequest = {},
        requestOptions?: CreditsClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.CountCreditSpendPoliciesResponse> {
        return core.HttpResponsePromise.fromPromise(this.__countCreditSpendPolicies(request, requestOptions));
    }

    private async __countCreditSpendPolicies(
        request: Schematic.CountCreditSpendPoliciesRequest = {},
        requestOptions?: CreditsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Schematic.CountCreditSpendPoliciesResponse>> {
        const { billingCreditId, companyId, scopeType, userId, userIds, limit, offset } = request;
        const _queryParams: Record<string, unknown> = {
            billing_credit_id: billingCreditId,
            company_id: companyId,
        ...
        if (_response.ok) {
            return {
                data: serializers.CountCreditSpendPoliciesResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    /**
     * @param {Schematic.ListCreditEventLedgerRequest} request
     * @param {CreditsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
    ...
    public listCreditEventLedger(
        ...
        requestOptions?: CreditsClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.ListCreditEventLedgerResponse> {
        return core.HttpResponsePromise.fromPromise(this.__listCreditEventLedger(request, requestOptions));
    }

    private async __listCreditEventLedger(
        request: Schematic.ListCreditEventLedgerRequest,
        requestOptions?: CreditsClient.RequestOptions,
        ...
        if (_response.ok) {
            return {
                data: serializers.ListCreditEventLedgerResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/billing/credits/ledger");
    }

    /**
     * @param {Schematic.CountCreditEventLedgerRequest} request
     * @param {CreditsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Schematic.BadRequestError}
     * @throws {@link Schematic.UnauthorizedError}
    ...
    public countCreditEventLedger(
        ...
        requestOptions?: CreditsClient.RequestOptions,
    ): core.HttpResponsePromise<Schematic.CountCreditEventLedgerResponse> {
        return core.HttpResponsePromise.fromPromise(this.__countCreditEventLedger(request, requestOptions));
    }

    private async __countCreditEventLedger(
        request: Schematic.CountCreditEventLedgerRequest,
        requestOptions?: CreditsClient.RequestOptions,
        ...
        if (_response.ok) {
            return {
                data: serializers.CountCreditEventLedgerResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
